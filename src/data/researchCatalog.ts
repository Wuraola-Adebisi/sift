...
export const categories: ResearchCategory[] = [
  ...
  },
  {
    ...
    results: [
      ...
      },
      {
        ...
        whereItFallsShort: "Runs $10 over your stated ceiling.",
        whatWouldChangeThis:
  ...
  },
  {
    ...
    keywords: ["laptop", "laptops", "macbook", "notebook"],
    exampleBrief:
    ...
    criteria: [
      { label: "Use case", value: "Frontend development" },
      { label: "Budget", value: "Around $1,200" },
      { label: "Priority", value: "Battery life" },
      { label: "Secondary", value: "Portability" },
    ],
    takeaway:
      "The MacBook Air fits the brief most closely because battery life, portability, and development performance all score well without paying for gaming-oriented hardware you don't need.",
    results: [
      {
        rank: "01",
        name: 'MacBook Air 15"',
        ...
        verdict: "Buy",
        whyItFits:
          "Strong battery life for a full day away from a charger, excellent performance for frontend work with many Chrome tabs open, and a large display without excessive weight.",
        whereItFallsShort:
          "Limited ports, so you will likely need a hub or dongle depending on your setup.",
        whatWouldChangeThis:
          "If a wider range of native ports mattered more to you than staying in the Apple ecosystem, the Dell XPS would be worth a closer look.",
        specs: [
          { label: "Battery", value: "Up to 18h" },
          { label: "Weight", value: "3.3lb" },
        ],
      },
      {
        rank: "02",
        ...
        verdict: "Consider",
        whyItFits:
          "Compact and capable, and comfortably under budget while covering everyday development work.",
        whereItFallsShort:
          "The smaller 13-inch display makes extended coding sessions less comfortable than a larger screen.",
        whatWouldChangeThis:
          "If saving money mattered more to you than screen size, this moves ahead of the MacBook Air.",
        specs: [
          { label: "Battery", value: "Up to 12h" },
          { label: "Weight", value: "2.6lb" },
        ],
      },
      {
        rank: "03",
        ...
        verdict: "Skip",
        whyItFits:
          "Good value with a flexible 2-in-1 form factor and enough performance for web development.",
        whereItFallsShort:
          "Display quality and overall build are a step below the other two, and battery life trails both.",
        whatWouldChangeThis:
          "If budget was the dominant constraint rather than build quality or battery life, this becomes the practical pick.",
        specs: [
          { label: "Battery", value: "Up to 10h" },
          { label: "Weight", value: "3.0lb" },
        ],
      },
    ],
  },
 ...
 * each category's keywords (simple substring matching — a real AI layer
 * would replace this with actual requirement extraction, which also
 * handles phrasing this can't) and returns the best match, or null if
 * nothing in the demo catalog applies.
 */
